...
CREATE TABLE `Coupon` (
  ...
  `target_credit` int(11) DEFAULT '-1',
  `target_roomnum` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
...
INSERT INTO `Coupon` VALUES (2,'满500-100优惠',2,1,'满减优惠券',500,0,1,NULL,NULL,100,-1,0);
...
INSERT INTO `User` VALUES (1,'1012681@qq.com','123456','测试一号','12345678919',100,'HotelManager','男','2000-12-02','440981200012024655'),(2,'123@qq.com','123456','测试二号','12345678911',100,'HotelManager','女','2000-05-07','440981200012024666'),(3,'321@qq.com','123456','测试号','12345678919',100,'Manager','男','2000-12-02','440981200012024655'),(6,'333@qq.com','123456','测试三号','12345678916',100,'HotelManager','男','1980-10-12','440981200012024677');
