...
<!--新增性别-->
          <a-form-item>
            <a-input
                    ...
                    v-decorator="[
              'registerSexType',
              {rules: [{ required: true, message: '请输入您的性别' },{ validator: this.handlesexType }], validateTrigger: 'blur'}]">
              <a-icon slot="prefix" type="user" :style="{ color: 'rgba(0,0,0,.25)' }"/>
            </a-input>
          </a-form-item>
...
<!--新增出生日期-->
          <a-form-item>
            <a-input
                    ...
                    v-decorator="[
              'registerBirth_date',
              {rules: [{ required: true, message: '请输入您的出生日期：xxxx-xx-xx' }], validateTrigger: 'blur'}]">
              <a-icon slot="prefix" type="book" :style="{ color: 'rgba(0,0,0,.25)' }"/>
            </a-input>
          </a-form-item>
      ...
      validateFields(validateFieldsKey, { force: true }, async (err, values) => {
        if (!err) {
          ...
          const data = {
            ...
            birth_date: this.form.getFieldValue('registerBirth_date'),        //新增用户出生日期
